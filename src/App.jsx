...
function App() {
  ...
  return (
    ...
    <h1
        className="inline-block font-extrabold bg-gradient-to-r from-purple-400 to-yellow-900 bg-clip-text text-7xl text-transparent"
      >
        Purple to Brown
      </h1>
            ...
            {move.moves.map((m) => ( // Map through each move
              <li key={m.name}>
                <a
                  ...
                  className="font-medium text-yellow-900 dark:text-yellow-700 hover:underline"
                >
                  {m.name}
                </a>
